...
// [OVERO-POSTPROCESSING] - start
typedef void *OveroHandle;
NEAACDECAPI void NeAACDecInitForOvero(NeAACDecHandle hpDecoder, int overo_mode, char *sbi_file_path, char *olp_file_path);
NEAACDECAPI unsigned char loadSpeechPrivacySensitiveBlockIndices(OveroHandle hpOvero, char *sbi_file_path);
// [OVERO-POSTPROCESSING] - end
